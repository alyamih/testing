...
friend(mail)
time.sleep(3)
browser.find_element_by_xpath("//div[@class='rq0escxv l9j0dhe7 du4w35lb j83agx80 g5gj957u rj1gh0hx buofh1pr hpfvmrgz i1fnvgqd bp9cbjyn owycx6da btwxx1t3 b5q2rw42 lq239pai mysgfdmx hddg9phg']").click()
time.sleep(3)
browser.find_element_by_xpath("//div[@class='l6v480f0 f10w8fjw pybr56ya']").click()
...
browser = webdriver.Chrome(r'C:\Users\Alya\PycharmProjects\selenium\chromedriver.exe')
browser.get('https://www.facebook.com/')
browser.find_element_by_xpath("//a[@class='_42ft _4jy0 _6lti _4jy6 _4jy2 selected _51sy']").click()
firstname(mail)
time.sleep(3)
lastname(mail)
time.sleep(3)
browser.find_element_by_xpath("//button[@name='websubmit']").click()